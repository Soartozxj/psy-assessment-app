...
icon: "🧮"
currentVersion: "1.0"
flowSteps: [{"num": "1", "color": "success", "title": "📋 复制提示词", "desc": "后台 → 系统提示词 → 计分解析 → 点「📋 复制正文」"}, {"num": "2", "color": "success", "title": "📄 追加计分规则", "desc": "在「[计分规则原文在下方]」后粘贴量表手册计分规则文字"}, {"num": "3", "color": "highlight-success", "title": "📥 获取 JSON 配置", "desc": "核对摘要无误后复制评分引擎 JSON 配置 → 粘贴至计分规则输入框"}]
note: "用于 AI 解析量表计分规则文字，输出评分引擎 JSON 配置"
versions:
  - version: "1.0"
    status: active
    date: "2026-05-05"
    note: "初始版本，从 ai-scoring-test.html getDefaultPromptText() 提取"
---
## ✅ v1.0 — 初始版本，从 ai-scoring-test.html getDefaultPromptText() 提取
