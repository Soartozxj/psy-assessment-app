...
(function (global) {
  ...
  UIUtils.showConfirm = function (options) {
    ...
    const config = Object.assign({}, _confirmConfig, options);
  ...
  function _showConfirmModal(config, resolve) {
    ...
    const titleEl = document.getElementById('confirm-text');
    const messageEl = document.getElementById('confirm-sub');
