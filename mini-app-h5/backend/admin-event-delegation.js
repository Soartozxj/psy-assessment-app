...
(function (global) {
  ...
  EventDelegate.init = function () {
    ...
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-prevent]');
      if (target) {
        e.preventDefault();
      }
    });
    ...
    // 管理员登录
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="admin-login"]');
    ...
    // 通用删除按钮 - 移除父元素
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="remove-parent"]');
      if (target) {
    ...
    // 通用切换类名
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="toggle-class"]');
      if (target) {
    ...
    document.addEventListener('click', function (e) {
      ...
      if (target) {
        ...
        const tabGroup = target.getAttribute('data-tab-group') || 'tab';
    ...
    // 面板切换（显示/隐藏 + 图标文字切换）
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="toggle-panel"]');
      if (target) {
        ...
        const loadFn = target.getAttribute('data-load'); // 可选：切换时调用的函数名
    ...
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="close-this-modal"]');
      if (target) {
    ...
    // 导航切换（切换主面板）
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="switch-section"]');
      if (target) {
        const section = target.getAttribute('data-section');
        const afterSwitch = target.getAttribute('data-after'); // 格式: "functionName" 或 "functionName:param"
    ...
    // Tab 切换（切换选项卡）
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="switch-tab"]');
      if (target) {
    ...
    // NPC Tab 切换
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="switch-npc-tab"]');
      if (target) {
        const tab = target.getAttribute('data-tab');
    ...
    // Ops Tab 切换
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="switch-ops-tab"]');
      if (target) {
        const tab = target.getAttribute('data-tab');
    ...
    // 计分面板 Tab 切换
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="switch-sc-panel"]');
      if (target) {
    ...
    // 分类筛选（图标分类等）
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="filter-category"]');
      if (target) {
    ...
    // 刷新状态（AI密钥状态等）
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="refresh-status"]');
      if (target) {
    ...
    // 显示 Toast 提示
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="show-toast"]');
      if (target) {
    ...
    // Ops: 刷新 AI 状态
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="ops-check-ai"]');
    ...
    // Ops: 从服务端加载 AI Keys
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="ops-load-keys"]');
    ...
    // Ops: 检查服务端 Keys 状态
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="ops-check-server-keys"]');
    ...
    // Ops: 保存配置
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="ops-save-config"]');
    ...
    // Ops: 健康检查
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="ops-health-check"]');
    ...
    // Reset: AI 诊断提示词
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="reset-ai-diag"]');
    ...
    // Reset: 咨询师筛选
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="reset-counselor-filters"]');
    ...
    // Reset: 背景筛选
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="reset-background-filters"]');
    ...
    // Reset: 过渡语筛选
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="reset-transition-filters"]');
    ...
    // Modal: 打开新建量表弹窗
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="open-create-modal"]');
    ...
    // Modal: 打开新增类型弹窗
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="open-create-type-modal"]');
    ...
    // Modal: 打开过渡语弹窗
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="open-transition-modal"]');
    ...
    // 通用操作: 下载模板
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="download-template"]');
      if (target) {
    ...
    // 通用操作: 下载量表模板
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="download-scale-template"]');
    ...
    // 通用操作: 保存配置
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="save-config"]');
      if (target) {
    ...
    // 通用操作: 导出记录
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="export-records"]');
    ...
    // 通用操作: 同步到前端
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="sync-frontend"]');
    ...
    // 通用操作: 从云端拉取
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="pull-cloud"]');
    ...
    // 通用操作: 导出所有数据
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="export-all"]');
    ...
    // 通用操作: 保存编辑
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="save-edit"]');
      if (target) {
    ...
    // 通用操作: 测试
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="test"]');
      if (target) {
    ...
    // 通用操作: 生成
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="generate"]');
      if (target) {
    ...
    // 通用操作: 手动同步
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="manual-sync"]');
      if (target) {
    ...
    // 通用操作: 切换拖拽排序模式
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="toggle-drag-sort"]');
    ...
    // 通用操作: 恢复/还原
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="restore"]');
      if (target) {
    ...
    // 通用操作: 确认操作
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="confirm-action"]');
      if (target) {
    ...
    // 通用操作: 显示弹窗
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="show-dialog"]');
      if (target) {
    ...
    // 通用操作: 新增步骤
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="add-step"]');
    ...
    // 通用操作: 添加元素
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="add-item"]');
      if (target) {
    ...
    // 评分配置: 添加维度/指标/分档
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="sc-add"]');
      if (target) {
    ...
    // 反馈：切换主 Tab
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="fb-switch-main-tab"]');
    ...
    // 反馈：设置星级筛选
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="fb-admin-set-star-filter"]');
    ...
    // 反馈：切换标签场景
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="fb-tag-switch-scene"]');
    ...
    // 反馈：切换标签类型
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="fb-tag-switch-type"]');
    ...
    // 反馈：添加标签
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="fb-tag-add-tags"]');
    ...
    // 反馈：查看详情（动态生成按钮）
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="fb-admin-show-detail"]');
      if (target) {
    ...
    // 反馈：删除（动态生成按钮）
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="fb-admin-delete"]');
      if (target) {
        const id = target.getAttribute('data-id');
    ...
    // 反馈：分页跳转（动态生成按钮）
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="fb-admin-go-page"]');
      if (target) {
    ...
    // 反馈：删除标签（动态生成按钮）
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="fb-tag-delete"]');
      if (target) {
        const id = target.getAttribute('data-id');
    ...
    // 提示词：关闭版本编辑弹窗
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="sp-close-ver-edit"]');
    ...
    // 提示词：保存版本
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="sp-save-ver-edit"]');
    ...
    // 提示词：关闭新建弹窗
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="sp-close-new-prompt"]');
    ...
    // 提示词：创建新提示词
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="sp-create-new-prompt"]');
    ...
    // 提示词：填充模板
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="sp-fill-template"]');
      if (target) {
    ...
    // 应用预设
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="apply-preset"]');
      if (target) {
    ...
    // 自动分配过渡语
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="auto-assign-transitions"]');
    ...
    // 打开编辑咨询师选择器
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="open-edit-counselor-picker"]');
    ...
    // 打开编辑背景选择器
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="open-edit-bg-picker"]');
    ...
    // 向导：上一步
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-prev-step"]');
    ...
    // 向导：下一步
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-next-step"]');
    ...
    // 关闭计分规则弹窗
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="close-scoring-modal"]');
    ...
    // 切换计分面板 Tab
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="sc-switch-panel"]');
      if (target) {
        const index = parseInt(target.getAttribute('data-index'), 10);
        if (!isNaN(index) && typeof switchScPanel === 'function') {
          switchScPanel(target, index);
    ...
    // 添加维度
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="sc-add-dimension"]');
    ...
    // 添加指标
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="sc-add-metric"]');
    ...
    // 自动推导分值范围
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="sc-auto-fill-ranges"]');
    ...
    // 添加分档规则
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="sc-add-interp-rule"]');
    ...
    // 添加筛查条件
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="sc-add-screen-cond"]');
    ...
    // 删除测前调查题目
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="delete-pre-question"]');
      if (target) {
    ...
    // 添加测前调查选项
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="add-pre-q-opt"]');
      if (target) {
        const qi = parseInt(target.getAttribute('data-qi'), 10);
    ...
    // 添加维度解释
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="sc-add-dim-interp"]');
    ...
    // 折叠/展开维度卡片
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="sc-toggle-dim"]');
      if (target) {
    ...
    // 删除维度卡片
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="sc-remove-dim"]');
      if (target) {
    ...
    // 复制提示词内容
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="sp-copy-content"]');
    ...
    // 添加版本
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="sp-add-version"]');
    ...
    // 保存流程完成
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="sp-save-flow-done"]');
    ...
    // 选择量表（计分）
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="select-scoring-scale"]');
      if (target) {
    ...
    // 运行计分测试
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="sc-run-test"]');
    ...
    // 保存 NPC 编辑
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="save-npc-edit"]');
    ...
    // 打开图标选择器
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="open-icon-picker"]');
    ...
    // 从云端拉取
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="pull-from-cloud"]');
      if (target && typeof pullFromCloud === 'function') {
        pullFromCloud();
      }
    });
    ...
    // 渲染选项列表
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="render-option-list"]');
    ...
    // 切换下拉菜单
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="toggle-dropdown"]');
    ...
    // 测试 AI Key 配置
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="ops-test-ai-key"]');
    ...
    // 保存 API Base
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="ops-save-api-base"]');
    ...
    // 保存 AI Keys
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="ops-save-ai-keys"]');
    ...
    // 查看量表类型
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="view-scale-type"]');
      if (target) {
    ...
    // 管理量表类型
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="manage-scale-type"]');
      if (target) {
        const typeId = target.getAttribute('data-type-id');
    ...
    // 打开编辑弹窗
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="open-edit-modal"]');
      if (target) {
        const scaleId = target.getAttribute('data-scale-id');
    ...
    // 筛选图标
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="filter-icons"]');
      if (target) {
        const category = target.getAttribute('data-category');
        if (category && typeof filterIconsByCategory === 'function') {
          filterIconsByCategory(category);
    ...
    // FB: 关闭详情弹窗（点击背景）
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="fb-close-overlay"]');
    ...
    // FB: 移除详情弹窗
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="fb-remove-overlay"]');
      if (target) {
        const overlay = document.getElementById('fb-detail-overlay');
        if (overlay) {
          overlay.remove();
    ...
    // AIC: 选择提供商
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="aic-select-provider"]');
    ...
    // AIC: 切换密钥可见性
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="aic-toggle-visibility"]');
    ...
    // AIC: 从服务端加载
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="aic-load-server"]');
    ...
    // AIC: 检查双端状态
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="aic-check-status"]');
    ...
    // AIC: 保存到服务端
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="aic-save-server"]');
    ...
    // PV: 复制正文
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="pv-copy-content"]');
    ...
    // PV: 重命名
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="pv-rename"]');
    ...
    // PV: 删除
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="pv-delete"]');
    ...
    // PV: 关闭编辑
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="pv-close-edit"]');
    ...
    // PV: 保存编辑
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="pv-save-edit"]');
    ...
    // PV: 切换版本
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="pv-switch-version"]');
      if (target) {
        const index = parseInt(target.getAttribute('data-index'), 10);
    ...
    // PV: 打开版本编辑
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="pv-open-edit"]');
      if (target) {
        e.stopPropagation();
        const index = parseInt(target.getAttribute('data-index'), 10);
    ...
    // PV: 删除版本
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="pv-del-version"]');
      if (target) {
        e.stopPropagation();
        const index = parseInt(target.getAttribute('data-index'), 10);
    ...
    // PV: 新增版本
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="pv-add-version"]');
    ...
    // AST: 上传文件
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="ast-upload-file"]');
      if (target) {
    ...
    // AST: 开始提取
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="ast-start-extract"]');
    ...
    // AST: 开始解析
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="ast-start-parse"]');
    ...
    // AST: 清空
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="ast-clear-all"]');
    ...
    // AST: 加载示例
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="ast-load-example"]');
      if (target) {
    ...
    // AST: 切换 Prompt 面板
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="ast-toggle-prompt-panel"]');
    ...
    // AST: 复制 Prompt
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="ast-copy-prompt"]');
    ...
    // AST: 切换编辑模式
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="ast-toggle-edit"]');
    ...
    // AST: 保存编辑
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="ast-save-edit"]');
    ...
    // AST: 取消编辑
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="ast-cancel-edit"]');
    ...
    // AST: 恢复默认
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="ast-reset-prompt"]');
    ...
    // AST: 切换调试信息
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="ast-toggle-debug"]');
    ...
    // AST: 复制原始 JSON
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="ast-copy-json"]');
    ...
    // AST: 标准化 + 验证
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="ast-normalize-verify"]');
    ...
    // AST: 复制标准化 JSON
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="ast-copy-normalized"]');
    ...
    // TC: 登录
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="tc-login"]');
    ...
    // TC: 批量测试报告
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="tc-show-batch-report"]');
    ...
    // TC: 导出用例
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="tc-export-suite"]');
    ...
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="tc-import-file"]');
      if (target) {
    ...
    // TC: 跳转计分配置页
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="tc-go-config"]');
      if (target) {
    ...
    // TC: 上一步
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="tc-prev-step"]');
    ...
    // TC: 下一步
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="tc-next-step"]');
    ...
    // TC: 显示保存用例弹窗
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="tc-show-save-case"]');
    ...
    // TC: 切换 Tab
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="tc-switch-tab"]');
      if (target) {
        const tabId = target.getAttribute('data-tab-id');
        if (tabId && typeof switchTab === 'function') {
          switchTab(tabId);
    ...
    // TC: 运行测试
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="tc-run-test"]');
    ...
    // TC: 清空答案
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="tc-clear-answers"]');
    ...
    // TC: 保存为用例
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="tc-save-as-case"]');
    ...
    // TC: AI 预览
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="tc-ai-preview"]');
    ...
    // TC: 复制 Prompt
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="tc-copy-prompt"]');
    ...
    // TC: 保存 Prompt 到量表
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="tc-save-prompt"]');
    ...
    // TC: 复制 AI 报告
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="tc-copy-ai-report"]');
    ...
    // TC: 关闭批量测试弹窗
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="tc-close-batch-modal"]');
      if (target) {
    ...
    // TC: 取消保存用例
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="tc-cancel-save-case"]');
      if (target) {
    ...
    // TC: 确认保存用例
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="tc-confirm-save-case"]');
    ...
    // TC: 应用预设（动态生成按钮）
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="tc-apply-preset"]');
      if (target) {
        const preset = target.getAttribute('data-preset');
        if (preset && typeof applyPreset === 'function') {
          applyPreset(preset);
    ...
    // TC: 加载用例（动态生成）
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="tc-load-case"]');
      if (target) {
    ...
    // 打开选项管理器
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="open-option-manager"]');
      if (target) {
    ...
    // 向导：关闭窗口
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-close"]');
      if (target) {
        window.close();
      }
    });
    ...
    // 向导：清空量表文本
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-clear-text"]');
      if (target) {
    ...
    // 向导：复制文本
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-copy"]');
      if (target) {
    ...
    // 向导：AI 生成量表
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-ai-generate"]');
    ...
    // 向导：显示 JSON 输入
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-show-json"]');
    ...
    // 向导：解析 JSON
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-parse-json"]');
    ...
    // 向导：格式化 JSON
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-format-json"]');
    ...
    // 向导：下载模板下拉
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-template-dropdown"]');
    ...
    // 向导：下载模板项
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-download-template"]');
      if (target) {
    ...
    // 向导：清空 JSON
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-clear-json"]');
    ...
    // 向导：切换折叠
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-toggle-collapsible"]');
      if (target) {
        const id = target.getAttribute('data-id');
    ...
    // 向导：生成计分说明
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-gen-sc-desc"]');
    ...
    // 向导：重新生成计分说明
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-regen-sc-desc"]');
    ...
    // 向导：清空计分说明
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-clear-sc-desc"]');
    ...
    // 向导：生成计分规则
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-gen-scoring"]');
    ...
    // 向导：预览计分提示词
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-preview-sc-prompt"]');
    ...
    // 向导：关闭计分提示词预览
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-close-sc-preview"]');
      if (target) {
    ...
    // 向导：切换计分 Tab
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-switch-sc-tab"]');
      if (target) {
        const tab = target.getAttribute('data-tab');
    ...
    // 向导：导入计分 JSON
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-import-scoring"]');
    ...
    // 向导：清空计分规则
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-clear-scoring"]');
    ...
    // 向导：添加维度
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-add-dim"]');
    ...
    // 向导：添加指标
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-add-metric"]');
    ...
    // 向导：自动推导范围
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-auto-fill-ranges"]');
    ...
    // 向导：添加分档规则
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-add-interp"]');
    ...
    // 向导：运行模拟测试
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-run-test"]');
    ...
    // 向导：保存计分规则
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-save-scoring"]');
    ...
    // 向导：重置计分规则
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-reset-scoring"]');
    ...
    // 向导：应用提示词版本
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-apply-prompt"]');
    ...
    // 向导：生成提示词
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-gen-prompt"]');
    ...
    // 向导：重置提示词
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-reset-prompt"]');
    ...
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-toggle-meta"]');
    ...
    // 向导：AI 优化发布字段
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-ai-optimize"]');
    ...
    // 向导：应用 AI 建议
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-apply-ai"]');
    ...
    // 向导：上一步
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-prev"]');
    ...
    // 向导：下一步
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-next"]');
    ...
    // 向导：发布
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-publish"]');
    ...
    // 向导：打开管理后台
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-open-admin"]');
    ...
    // 向导：开始新向导
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-new"]');
    ...
    // 向导：跳转到步骤
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-go-step"]');
      if (target) {
    ...
    // 向导：从弹窗跳转到步骤
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-go-step-modal"]');
      if (target) {
        const step = parseInt(target.getAttribute('data-step'), 10);
    ...
    // 向导：应用 AI 行样式
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-apply-row"]');
      if (target) {
    ...
    // 向导：折叠/展开维度卡片
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-toggle-dim"]');
      if (target) {
    ...
    // 向导：删除父元素（通用）
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-remove-self"]');
      if (target) {
        const parent = target.parentElement;
        if (parent) {
          parent.remove();
    ...
    // 向导：添加维度解释
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-add-dim-interp"]');
    ...
    // 向导：添加筛查条件
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-add-screen-cond"]');
    ...
    // 向导：关闭弹窗
    document.addEventListener('click', function (e) {
      const target = e.target.closest('[data-action="wizard-close-modal"]');
      if (target) {
